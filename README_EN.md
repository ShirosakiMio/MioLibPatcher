...
| Target class                                                                                                                                                                                                                               | Fix                                                                                                                                                                |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `com.mojang.text2speech.Narrator`                                                                                                                                                                                                          | Disables TTS; `getNarrator` returns a dummy implementation (disabled by default; the launcher provides a libflite bridge to Android TTS)                            |
| `com.mojang.text2speech.NarratorLinux`                                                                                                                                                                                                     | Narrator interruption: injects a JNA call into `clear()` so the bridge stops the system TTS speech immediately (disable with `-Dmiolibpatcher.ttsCancel=false`)     |
...
| `miolibpatcher.ttsDisable`  | `true` disables TTS (returns a dummy implementation), default `false`                            |
